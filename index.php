        ...
        <form action="Data.php" method="post">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            <input type="number" id="nim" name="nim" placeholder="Nomer Induk Mahasiswa">
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>No Hp</td>
                    <td>
                        <input id="telfon" name="telfon" type="Number" placeholder="08xxxxxxxxxx" aria-label="Username" aria-describedby="basic-addon1"></div>
                    </td>
                </tr>
                <tr>
                    <td>Alamat</td>
